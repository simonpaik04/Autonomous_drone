...
void loop() {
  ...
  static uint32_t calibrationStart = millis();
  ...
  Serial.printf(" | throttle=%4.0f", throttle);
  Serial.printf(" | A=%4.0f B=%4.0f C=%4.0f D=%4.0f", speedA, speedB, speedC, speedD);
  Serial.println();
}
